...
const TERMS_SECTIONS = {
  ja: [
    ...
    { h: "第7条　免責事項", b: "本サービスは出品者と購入者の仲介プラットフォームであり、以下について一切の保証を行いません。\n・スキルの品質、正確性、動作、目的適合性\n・スキルに含まれるコードの安全性（ウイルス、マルウェア等の不存在）\n・スキルの利用により得られる成果\n\n運営は、本サービスの利用または利用不能により生じた以下の損害について、一切責任を負いません。\n・直接損害、間接損害、特別損害、結果的損害、逸失利益\n・データの消失、破損、漏洩\n・マルウェア感染、システム障害、第三者からの不正アクセス\n・本サービスの一時停止、終了、システム障害\n\n利用者は自己の責任において本サービスを利用するものとし、ダウンロードしたファイルの安全性確認（ウイルススキャン等）は利用者自身で行うものとします。\n\n万一運営が責任を負う場合であっても、その責任範囲は当該利用者が直近12ヶ月間に本サービスに支払った金額を上限とします。" },
    { h: "第8条　規約の変更", b: "本規約は事前通知なく変更される場合があります。変更後も本サービスを継続して利用した場合、変更後の規約に同意したものとみなします。" },
    { h: "第9条　アップロードファイルに関する責任", b: "利用者がアップロードまたはダウンロードするファイルについて、以下の事項に同意するものとします。\n・アップロードファイルの内容、合法性、安全性は当該アップロード者が全責任を負う\n・ダウンロードファイルは利用者自身の責任において使用し、事前にウイルススキャン等の安全性確認を行う\n・運営はファイルの安全性を技術的に検査する義務を負わない\n・ファイルに起因する損害（マルウェア感染、データ損失、業務中断等）について、運営は一切責任を負わない" },
    { h: "第10条　準拠法", b: "本規約は日本法に準拠し、日本の裁判所を管轄裁判所とします。" },
  ],
  en: [
    ...
    { h: "Article 7 — Disclaimer", b: "The Service is an intermediary platform between sellers and buyers, and the operator makes no warranties regarding:\n• Quality, accuracy, functionality, or fitness for purpose of skills\n• Safety of code contained in skills (absence of viruses, malware, etc.)\n• Results obtained from using skills\n\nThe operator shall not be liable for any damages arising from the use or inability to use the Service, including but not limited to:\n• Direct, indirect, special, consequential damages, or lost profits\n• Loss, corruption, or leakage of data\n• Malware infection, system failures, or unauthorized third-party access\n• Temporary suspension, termination, or system failures of the Service\n\nUsers use the Service at their own risk and are responsible for verifying the safety of downloaded files (e.g., by running virus scans).\n\nIn any case where the operator is held liable, such liability shall be limited to the amount paid by the user to the Service in the preceding 12 months." },
    ...
    { h: "Article 9 — Responsibility for Uploaded Files", b: "Users agree to the following regarding files uploaded to or downloaded from the Service:\n• The uploader bears full responsibility for the content, legality, and safety of uploaded files\n• Downloaded files are used at the user's own risk; users must perform safety checks (e.g., virus scans) before use\n• The operator has no obligation to technically inspect files for safety\n• The operator bears no liability for damages caused by files (malware infection, data loss, business interruption, etc.)" },
    { h: "Article 10 — Governing Law", b: "These Terms are governed by the laws of Japan, and the courts of Japan shall have exclusive jurisdiction." },
  ],
};
