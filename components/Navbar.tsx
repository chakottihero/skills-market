...
export default function Navbar() {
  ...
  return (
    <>
      {/* Toast */}
      {toast && (
        <div className="fixed top-20 left-1/2 -translate-x-1/2 z-[100] bg-amber-50 border border-amber-300 text-amber-800 text-sm px-5 py-3 rounded-xl shadow-lg flex items-center gap-2 max-w-sm w-full mx-4">
          <span>⚙️</span>
          <span>{toast}</span>
